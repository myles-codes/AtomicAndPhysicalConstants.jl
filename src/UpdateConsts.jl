...
CODATA_Consts = Dict{AbstractString, Dict{AbstractString, Float64}}(
	"electron mass energy equivalent in MeV" => Dict("m_electron" => __b_m_electron), 
	"proton mass energy equivalent in MeV" => Dict("m_proton" => __b_m_proton), 
	"neutron mass energy equivalent in MeV" => Dict("m_neutron" => __b_m_neutron), 
	"muon mass energy equivalent in MeV" => Dict("m_muon" => __b_m_muon), 
	"helion mass energy equivalent in MeV" => Dict("m_helion" => __b_m_helion), 
	"deuteron mass energy equivalent in MeV" => Dict("m_deuteron" => __b_m_deuteron), 
	"speed of light in vacuum" => Dict("c_light" => __b_c_light), 
	"Planck constant in eV/Hz" => Dict("h_planck" => __b_h_planck), 
	"classical electron radius" => Dict("r_e" => __b_r_e), 
	"Avogadro constant" => Dict("N_avogadro" => __b_N_avogadro), 
	"vacuum electric permittivity" => Dict("eps_0_vac" => __b_eps_0_vac), 
	"vacuum mag. permeability" => Dict("mu_0_vac" => __b_mu_0_vac), 
	"fine-structure constant" => Dict("fine_structure" => __b_fine_structure), 
	"muon mag. mom. anomaly" => Dict("anom_mag_moment_muon" => __b_anom_mag_moment_muon), 
	"electron mag. mom. anomaly" => Dict("anom_mag_moment_electron" => __b_anom_mag_moment_electron), 
	"proton mag. mom. to nuclear magneton ratio" => Dict("anom_mag_moment_proton" => __b_anom_mag_moment_proton), 
	"deuteron mag. mom. to nuclear magneton ratio" => Dict("anom_mag_moment_deuteron" => __b_anom_mag_moment_deuteron), 
	"neutron mag. mom. to nuclear magneton ratio" => Dict("anom_mag_moment_neutron" => __b_anom_mag_moment_neutron), 
	"helion mag. mom. to nuclear magneton ratio" => Dict("anom_mag_moment_He3" => __b_anom_mag_moment_He3), 
	"elementary charge" => Dict("e_charge" => e_charge),
	"atomic mass unit-kilogram relationship" => Dict("kg_per_amu" => __b_kg_per_amu),
	"atomic mass unit-electron volt relationship" => Dict("eV_per_amu" => __b_eV_per_amu)
);
