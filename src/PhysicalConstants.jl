...
__b_anom_mag_moment_electron    = 1.15965218128e-3;                # anomalous mag. mom. of the electron (unitless)
__b_anom_mag_moment_muon        = 1.16592089e-3;                   # ~fine_structure_ant / twopi
__b_anom_mag_moment_proton      = 1.79284734463e0;                 # μ_p/μ_N - 1
__b_anom_mag_moment_deuteron    = -0.14298726925e0;                # μ_{deuteron}/μ_N - 1
__b_anom_mag_moment_neutron     = -1.91304273e0;                   # μ_{neutron}/μ_N - 1
__b_anom_mag_moment_He3         = -4.184153686e0;                  # μ_{He3}/μ_N - 2
