...
__b_m_electron = 510998.95069 * u"eV/c^2"
# Electron Mass [eV]/c^2
__b_m_proton = 9.382720894300001e8 * u"eV/c^2"
# Proton Mass [eV]/c^2
__b_m_neutron = 9.395654219399999e8 * u"eV/c^2"
# Neutron Mass [eV]/c^2
__b_m_muon = 1.056583755e8 * u"eV/c^2"
# Muon Mass [eV]/c^2
__b_m_helion = 2.80839161112e9 * u"eV/c^2"
# Helion Mass He3 nucleus [eV]/c^2
__b_m_deuteron = 1.875612945e9 * u"eV/c^2"
# Deuteron Mass [eV]/c^2
__b_c_light = 2.99792458e8 * u"m/s"
# speed of light [m/s]
__b_h_planck = 4.135667696e-15 * u"eV*s"
...
# Joules per eV
__b_N_avogadro = 6.02214076e23 * u"1/mol"
...
__b_mu_deuteron = 4.330735087e-27 * u"eV/T"
# deuteron magnetic moment in [eV/T]
__b_mu_electron = -9.2847646917e-24 * u"eV/T"
# electron magnetic moment in [eV/T]
__b_mu_helion = -1.07461755198e-26 * u"eV/T"
# helion magnetic moment in [eV/T]
__b_mu_muon = -4.4904483e-26 * u"eV/T"
# muon magnetic moment in [eV/T]
__b_mu_neutron = -9.6623653e-27 * u"eV/T"
# neutron magnetic moment in [eV/T]
__b_mu_proton = 1.41060679545e-26 * u"eV/T"
# proton magnetic moment in [eV/T]
__b_mu_triton = 1.5046095178e-26 * u"eV/T"
...
# picked up from PDG
__b_m_pion_0 = 1.349768277676847e8 * u"eV/c^2"
# uncharged pion mass [eV]/c^2
__b_m_pion_charged = 1.3957039098368132e8 * u"eV/c^2"
